...
#increase score and speed of eggs
def increase_score(points):
    global score, egg_speed, egg_interval
    score += points                     #increase score
    egg_speed = int(egg_speed * difficulty_factor)  #increase speed of eggs
...
beep = mixer.Sound("beep.wav") #load the sound
beep.play() #play the sound
time.sleep(5) #keep the sound playing for 5 seconds